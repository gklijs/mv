...
(deftest image-test
  ...
  (testing "processing"
    (let [byte-array (Files/readAllBytes (.toPath (clojure.java.io/file "test/resources/img/cat_in_a_box.jpg")))
      ...
      (is (string/ends-with? (nth result 3) "/resources/public/img/gen/11.jpg"))
      (is (string/ends-with? (nth result 4) "/resources/public/img/gen/11-256.jpg"))
      (is (string/ends-with? (nth result 5) "/resources/public/img/gen/11-64.jpg"))
      (is (string/ends-with? (nth result 6) "/resources/public/img/gen/11-s.jpg"))
      (is (string/ends-with? (nth result 7) "/resources/public/img/gen/11-m.jpg"))
      (is (string/ends-with? (nth result 8) "/resources/public/img/gen/11-l.jpg"))))
  (testing "processing-small-image"
    (let [byte-array (Files/readAllBytes (.toPath (clojure.java.io/file "test/resources/img/celebration.png")))
      ...
      (is (string/ends-with? (nth result 3) "/resources/public/img/gen/12.jpg"))
      (is (string/ends-with? (nth result 4) "/resources/public/img/gen/12-256.jpg"))
      (is (string/ends-with? (nth result 5) "/resources/public/img/gen/12-64.jpg"))
      (is (= (nth result 6) nil))
      (is (= (nth result 7) nil))
      (is (= (nth result 8) nil)))))